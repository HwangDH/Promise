...
public class ContinueDetail_validate extends StringRequest {
    ...
    //완료했을 때
    public ContinueDetail_validate(String userphonenumber, String otherphonenumber, String id, String pid, Response.Listener<String> listener){
