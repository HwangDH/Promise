            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(success){
                        ...
                        Toast.makeText(CreatePromise.this, "사용자가 앱을 설치하지 않았습니다. 앱 설치를 요청페이지로 이동합니다..", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(CreatePromise.this,SendKakaoMessage.class);
                        startActivity(intent);
                    }
                }catch(Exception e){
                    e.printStackTrace();
